package com.alltheware.mousebits.Service;
...
//    private int mConnectionLostCount;
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(MouseActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(MouseActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MouseActivity.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
...
//        } else {
        ...
        Message msg = mHandler.obtainMessage(MouseActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MouseActivity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
//        }
    }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(MouseActivity.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
